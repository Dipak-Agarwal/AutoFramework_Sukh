...
public class ElementUtils {
	 ...
	 * @throws Exception
	 */
	public void waitForElementToBeVisible(WebDriver driver, WebElement element, int timeOut) throws Exception {
		try {
			FluentWait<WebDriver> wait = getFluentWaitFromDriver(timeOut, 1);
	 ...
	 * @param failureMessage
	 */
	public void verifyElementVisible(WebDriver driver, WebElement element, int timeOut, String failureMessage) {
		boolean displayed;
		try {
	...
	public void clickOnElement(WebDriver driver, WebElement element, int timeOut, String failureMessage) throws Exception {
		try {
			waitForElementToBeVisible(driver, element, timeOut);
			element.click();
		} catch (Exception e) {
	...
	public void enterValueForTextBox(WebDriver driver, WebElement element, String value, int timeOut, String failureMessage) throws Exception {
		try {
			waitForElementToBeVisible(driver, element, timeOut);
